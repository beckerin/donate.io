...
#### Dados
 ...
 ---                        | ---        | ---       | ---         | ---      | --- 
id_campanha                 | `integer`  | `default` | SIM         | SIM      | Id principal da campanha.  
...
||
fk_usuario_id_usuario       | `integer`  | `default` | SIM         | SIM      | [Id do Author](#Usuários)
...
NOME                        | TIPO       | TAMANHO   | OBRIGATÓRIO | COMPLETO | DESCRIÇÃO
 ---                        | ---        | ---       | ---         | ---      | --- 
id_usuario                  | `integer`  | `default` | SIM         | SIM      | Id do usuário.
...
||
fk_endereco_id_endereco     | `integer`  | `default` | SIM         | SIM      | [Id do Endereço](#endereço)
fk_tipo_de_usuario_id_tipo  | `integer`  | `default` | SIM         | SIM      | [Id do Tipo de usuário](#tipo-de-usuário)
...
NOME                                      | TIPO       | TAMANHO   | OBRIGATÓRIO | COMPLETO | DESCRIÇÃO
 ---                                      | ---        | ---       | ---         | ---      | --- 
id_doacao                                 | `integer`  | `default` | SIM         | SIM      | ID da doação
...
||
fk_status_de_pagamento_id_status_pagamento| `integer`  | `default` | SIM         | SIM      | [ID do tipo de pagamento](#status-de-pagamento)
fk_tipo_de_pagamento_id_tipo_pagamento    | `integer`  | `default` | SIM         | SIM      | [ID do tipo de pagamento](#tipo-de-Pagamento)
fk_campanha_id_campanha                   | `integer`  | `default` | SIM         | SIM      | [Id do Campanha](#campanha)
fk_usuario_id_usuario                     | `integer`  | `default` | SIM         | SIM      | [Id do Usuário](#usuários)
...
NOME                         | TIPO       | TAMANHO   | OBRIGATÓRIO | COMPLETO | DESCRIÇÃO
 ---                         | ---        | ---       | ---         | ---      | --- 
id_comentario                | `integer`  | `default` | SIM         | SIM      | Id do comentario.
...
||
fk_usuario_id_usuario        | `integer`  | `default` | SIM         | SIM      | [Id responsável](#usuários).
...
NOME                         | TIPO       | TAMANHO   | OBRIGATÓRIO | COMPLETO | DESCRIÇÃO
 ---                         | ---        | ---       | ---         | ---      | --- 
id_alteracao                 | `integer`  | `default` | SIM         | SIM      | Id da alteração.
...
||
fk_campanha_id_campanha      | `integer`  | `default` | NÃO         | SIM      | [Id da campanha alterada](#campanha).
fk_comentario_id_comentario  | `integer`  | `default` | NÃO         | SIM      | [Id do comentário alterado](#comentários).
fk_usuario_id_usuario        | `integer`  | `default` | SIM         | SIM      | [Id responsável](#usuários).
...
NOME                       | TIPO       | TAMANHO   | OBRIGATÓRIO | COMPLETO | DESCRIÇÃO
 ---                       | ---        | ---       | ---         | ---      | --- 
id_endereco                | `integer`  | `default` | SIM         | SIM      | Id do endereço.
...
||
fk_cidade_id_cidade        | `integer`  | `default` | SIM         | SIM      | [Id da cidade](#cidades)
fk_estado_id_estado        | `integer`  | `default` | SIM         | SIM      | [Id do estado](#estados)
...
NOME        | TIPO       | TAMANHO   | OBRIGATÓRIO | COMPLETO | DESCRIÇÃO
 ---        | ---        | ---       | ---         | ---      | --- 
id_tipo     | `integer`  | `default` | SIM         | SIM      | Id tipo de usuário.
...
NOME                | TIPO       | TAMANHO   | OBRIGATÓRIO | COMPLETO | DESCRIÇÃO
 ---                | ---        | ---       | ---         | ---      | --- 
id_tipo_pagamento   | `integer`  | `default` | SIM         | SIM      | ID do status de pagamento.
...
NOME                | TIPO       | TAMANHO   | OBRIGATÓRIO | COMPLETO | DESCRIÇÃO
 ---                | ---        | ---       | ---         | ---      | --- 
id_tipo_pagamento   | `integer`  | `default` | SIM         | SIM      | ID do tipo de pagamento
...
NOME        | TIPO       | TAMANHO   | OBRIGATÓRIO | COMPLETO | DESCRIÇÃO
 ---        | ---        | ---       | ---         | ---      | --- 
id_cidade   | `integer`  | `default` | SIM         | SIM      | Id da cidade.
...
NOME        | TIPO       | TAMANHO   | OBRIGATÓRIO | COMPLETO | DESCRIÇÃO
 ---        | ---        | ---       | ---         | ---      | --- 
id_estado   | `integer`  | `default` | SIM         | SIM      | Id do estado.
